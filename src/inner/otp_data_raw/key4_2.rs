...
#[doc = "Register `KEY4_2` writer"]
pub type W = crate::W<KEY4_2_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`key4_2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`key4_2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`write(|w| ..)` method takes [`key4_2::W`](W) writer structure"]
impl crate::Writable for KEY4_2_SPEC {
