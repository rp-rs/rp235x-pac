...
#[doc = "Register `BOOTKEY2_2` writer"]
pub type W = crate::W<BOOTKEY2_2_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`bootkey2_2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`bootkey2_2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`write(|w| ..)` method takes [`bootkey2_2::W`](W) writer structure"]
impl crate::Writable for BOOTKEY2_2_SPEC {
