...
#[doc = "Register `BOOTKEY0_10` writer"]
pub type W = crate::W<BOOTKEY0_10_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`bootkey0_10::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`bootkey0_10::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`write(|w| ..)` method takes [`bootkey0_10::W`](W) writer structure"]
impl crate::Writable for BOOTKEY0_10_SPEC {
