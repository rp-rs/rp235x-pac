...
#[doc = "Register `KEY6_0` writer"]
pub type W = crate::W<KEY6_0_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`key6_0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`key6_0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`write(|w| ..)` method takes [`key6_0::W`](W) writer structure"]
impl crate::Writable for KEY6_0_SPEC {
